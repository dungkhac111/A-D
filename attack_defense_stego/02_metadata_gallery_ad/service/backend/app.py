...
CHECKER_TOKEN=os.environ.get("CHECKER_TOKEN","checker-secret"); CHALLENGE="metadata"; NAME="Metadata Gallery AD"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path=="/": return self.send_text(render("index.html",name=html.escape(NAME),technique="Web header leak + PNG metadata",probe="/archive?case=latest"),"text/html; charset=utf-8")
...
if __name__=="__main__": ensure_state(); port=int(os.environ.get("PORT","8085")); print(f"Metadata Gallery AD listening on 0.0.0.0:{port}"); ThreadingHTTPServer(("0.0.0.0",port),Handler).serve_forever()
