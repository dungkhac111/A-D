...
SERVICE_PORT=int(os.environ.get("SERVICE_PORT","8089")); CHECKER_TOKEN=os.environ.get("CHECKER_TOKEN","checker-secret"); TIMEOUT=int(os.environ.get("CHECKER_TIMEOUT","15")); FLAG_PREFIX=os.environ.get("FLAG_PREFIX","blockChainPTIT{"); ACTIONS={"check","put","get"}
